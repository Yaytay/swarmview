...
router.use('/metrics', (req, res) => {
  ...
  let stats = {
    ...
    , 'ctr_memory_stats_active_anon': [
      ...
      , '# TYPE ctr_memory_stats_active_anon gauge'
    ]
    ...
    , 'ctr_memory_stats_active_file': [
      ...
      , '# TYPE ctr_memory_stats_active_file gauge'
    ]
    ...
    , 'ctr_memory_stats_hierarchical_memory_limit': [
      ...
      , '# TYPE ctr_memory_stats_hierarchical_memory_limit gauge'
    ]
    ...
    , 'ctr_memory_stats_hierarchical_memsw_limit': [
      ...
      , '# TYPE ctr_memory_stats_hierarchical_memsw_limit gauge'
    ]
    ...
    , 'ctr_memory_stats_inactive_anon': [
      ...
      , '# TYPE ctr_memory_stats_inactive_anon gauge'
    ]
    ...
    , 'ctr_memory_stats_inactive_file': [
      ...
      , '# TYPE ctr_memory_stats_inactive_file gauge'
    ]
    , 'ctr_memory_stats_mapped_file': [
      ...
      , '# TYPE ctr_memory_stats_mapped_file gauge'
    ]
    ...
    , 'ctr_network_usage_tx_packets': [
      ...
      , '# TYPE ctr_network_usage_tx_packets gauge'
    ]
  }
